...
if [ -f ./.opencode/get-shit-done/VERSION ]; then
  ...
  echo "LOCAL"
elif [ -f /Users/mati/.config/opencode/get-shit-done/VERSION ]; then
  cat /Users/mati/.config/opencode/get-shit-done/VERSION
  echo "GLOBAL"
else
  echo "UNKNOWN"
fi
...
(Paths are relative to your install location: `/Users/mati/.config/opencode/` for global, `./.opencode/` for local)
...
**If GLOBAL install:**
```bash
rm -f /Users/mati/.config/opencode/cache/gsd-update-check.json
```
