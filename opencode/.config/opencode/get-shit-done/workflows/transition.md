...
```bash
TRANSITION=$(node /Users/mati/.config/opencode/get-shit-done/bin/gsd-tools.cjs phase complete "${current_phase}")
```
...
```bash
PROGRESS=$(node /Users/mati/.config/opencode/get-shit-done/bin/gsd-tools.cjs progress bar --raw)
```
...
```bash
node /Users/mati/.config/opencode/get-shit-done/bin/gsd-tools.cjs config-set workflow.auto_advance false
```
